requirejs.config({
    ...
    //the paths config could be for a directory.
     ...
     shim: {
     		...
     		'livicon':	['raphael'],
     		'kpdemocharts':	['sparkline' 'hc-highcharts' 'hc-funnel' 'hc-map' 'hc-exporting' 'hc-annotations' 'hc-canvas-tools'],
     		'bee': ['dm14' 'dm24' 'dm34' 'dm44']
     	}
    });
    
requirejs(['bootstrap', 'livicon', 'bee'], function($, bootstrap, livicon, bee){});