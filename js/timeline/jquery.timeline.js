		...
		init : function( options ) {
			 ...
			 // Default settings
   			var settings = $.extend( {
				...
				'categories'             : ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December','January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'], // categories shown above timeline (months are default)
			...
			$this.css({'overflow' : 'hidden', marginLeft : 'auto', marginRight : 'auto','text-align': 'center', height:0});
			...
			$this.find('.timeline_items_holder').css({overflow: 'hidden', width: '95%', marginLeft : 'auto', marginRight : 'auto'});
